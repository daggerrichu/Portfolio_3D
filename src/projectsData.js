...
export const workExperience = [
  {
    ...
    role: "UI/UX Designer",
    description: "Designed intuitive user interfaces, digital design systems, wireframes, and high-fidelity interactive prototypes for enterprise software products."
  },
  {
    period: "2021 – 2022",
    company: "IONAUGHT TECHNOLOGIES PVT LTD",
    role: "Software Engineer & UI/UX Designer",
    description: "Engineered web applications and led UI/UX design across multiple software roles, bridging digital architecture with human-centered interaction."
  }
];
...
export const activitiesAndInternships = [
  ...
  },
  {
    ...
    organization: "UKF College TVM"
  },
  {
    year: "2019",
    title: "AI & Face Recognition Workshop",
    organization: "IEEE SB & IEDC Cell, College of Engineering Attingal"
  }
];
...
export const projectsData = [
  ...
  {
    id: "project-6",
    title: "Medicine Delivery Mobile App",
  ...
  {
    id: "project-8",
    title: "Scratch Project Management Tool",
...
export const skillsList = [
  { name: "Unreal Engine", icon: "gamepad-2" },
  ...
  { name: "Sketch", icon: "pen-tool" },
  { name: "Premiere Pro", icon: "video" },
  { name: "Illustrator", icon: "palette" }
];

export const languagesList = [
  "English", "Hindi", "Malayalam", "Tamil", "Sanskrit"
];
